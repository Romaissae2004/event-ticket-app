...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TicketsSoldeOutException.class)
    public ResponseEntity<ErrorDto> handleTicketsSoldeOutException(TicketsSoldeOutException ex) {
        log.error("Caught TicketsSoldeOutException", ex);
        ErrorDto errorDto = new ErrorDto();
